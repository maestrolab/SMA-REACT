...
def Geometry_input():
    ...
    acceptable = ['C', 'S', 'R',
                  'P']  # This list represents allowable inputs. If input does not match one of the letters in "acceptable" list, program will ask user to input again.
