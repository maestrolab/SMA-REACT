...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Guess"))
        ...
        self.label_10.setText(_translate("MainWindow", "Guess"))
            ...
            for j in range(self.gridLayout.columnCount()):
                ...
                if (not val == ""):
                    ...
                    if (lower_bound <= val <= upper_bound):
                        self.gridLayout.itemAtPosition(i, j).itemAt(3).widget().setValue(val//step)
                    else:
